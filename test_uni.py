...
Pmin   =0.2E5        # Minimal pressure to be extracted
Pmax   =8.5E5        # Maximal pressure to be extracted
Tmin   =120.0        # Minimal temperature to be extracted
Tmax   =350.0        # Maximal temperature to be extracted
NbT    =123          # Number of isothermal lines (neglected if isobar used)
NbP    =123         # Number of isobar lines (neglected if isothermal used)
T      =444          #
P      =1.0
NE     =200           # Number of iso energy lines in final table
NRho   =200           # Number of isochoric lines in final table
...
#Create a Quadtree adaptive rho-E table
###########################################
