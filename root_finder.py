...
e_interp,T_interp, P_interp, H_interp, rho_act_int, cv_interp, cp_interp, a_interp, k_interp, mu_interp = pickle.load(f)

rinterp = rho_act_int
einterp = e_interp

interp = {'T': T_interp, 'P': P_interp, 'H': H_interp, 'Rho': rho_act_int, 'E': e_interp, 'CV': cv_interp, 'CP': cp_interp, 'a': a_interp, 'k': k_interp, 'mu': mu_interp}
